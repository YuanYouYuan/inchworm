function exceed = torque_exceed(theta, time, plot_torque, plot_trajectory)   
	if exist('plot_trajectory', 'var') && plot_trajectory == 1
		[th, dth, ddth, t] = joint_trajectory(theta, time, 1);
	else
	...
	if exist('plot_torque', 'var') && plot_torque == 1
		figure('Name', 'torque')
		for i = 1:size(torq, 1)
